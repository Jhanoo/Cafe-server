...
public class UserController {
	...
	public ResponseEntity<User> getInfo(HttpServletRequest request, String email) {
	...
	@Operation(summary = "사용자 이미지 삭제", 
			description = "userId에 해당하는 사용자의 이미지를 삭제합니다. 삭제된 파일의 이름을 반환합니다.")
